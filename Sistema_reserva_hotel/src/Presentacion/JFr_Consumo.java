 ...
 * @author CARLOS
 */
public class JFr_Consumo extends javax.swing.JInternalFrame {
    ...
    private void btnbuscarproductoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscarproductoActionPerformed
        // TODO add your handling code here:
        JFr_Vista_Producto form = new JFr_Vista_Producto();
        form.toFront();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFr_Consumo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFr_Consumo().setVisible(true);
            }
        });
    }
