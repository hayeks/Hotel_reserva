...
import Logica.F_Consumo;
import Logica.F_Habitacion;
import Logica.F_Pago;
import Logica.F_Reserva;
import java.io.File;
 ...
 * @author CARLOS
 */
public class JFr_Pago extends javax.swing.JInternalFrame {
    ...
    void mostrar(String buscar) {
        try {
            ...
            Logger.getLogger(JFr_Pago.class.getName()).log(Level.SEVERE, null, e);
    ...
    private void initComponents() {
        ...
        cbotipo_comprobante.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Factura", "Comprobante Fiscal", "Otro" }));
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
        ...
        if (accion.equals("guardar")) {
            if (func.insertar(dts)) {
                ...
                C_Habitacion dts2 = new C_Habitacion();
    ...
    private void btnImprimirComprobanteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirComprobanteActionPerformed
        if (!txtidpago.getText().equals("")) {
            Map p = new HashMap();
            p.put("id_pago", Integer.parseInt(txtidpago.getText()));
            JasperReport report;
            JasperPrint print;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFr_Pago.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
