 ...
 * @author CARLOS
 */
public class JFr_Reserva extends javax.swing.JInternalFrame {
    ...
    void mostrar(String buscar) {
        try {
            ...
            //ocultar_columnas();
            lbltotalregistros.setText("Total Registros " + Integer.toString(func.total_registro));

        } catch (Exception e) {
            Logger.getLogger(JFr_Reserva.class.getName()).log(Level.SEVERE, null, e);
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        .addComponent(txtidtrabajador, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                            .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGap(40, 40, 40)
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addComponent(txtnumero, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addComponent(txtcliente, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnnuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnnuevoActionPerformed
        ...
        btnguardar.setText("Guardar");
        accion = "guardar";
        //txtidtrabajador.setText(Integer.toString(C_Persona.getPersona().getId_persona()));
        txtidtrabajador.setText(MDI_Inicio.lbl_id_persona.getText());
        txttrabajador.setText(MDI_Inicio.lbl_nombre.getText()+" "+MDI_Inicio.lbl_apaterno.getText());
       ...
       C_Reserva dts = new C_Reserva();
        ...
        if (accion.equals("guardar")) {
            if (func.insertar(dts)) {
                ...
                C_Habitacion dts3 = new C_Habitacion();
            ...
            dts.setId_trabajador(Integer.parseInt(txtidtrabajador.getText()));            
            if (func.editar(dts)) {
    ...
    private void btnbuscahabitacionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscahabitacionActionPerformed
        // TODO add your handling code here:
        JFr_Vista_Habitacion form = new JFr_Vista_Habitacion();
        form.toFront();
    ...
    private void btnbuscaclienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscaclienteActionPerformed
        // TODO add your handling code here:
        JFr_Vista_Cliente form= new JFr_Vista_Cliente();
        form.toFront();
        form.setVisible(true);
    ...
    private void btnverconsumoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnverconsumoActionPerformed
        ...
        JFr_Consumo.idreserva= tablalistado.getValueAt(fila, 0).toString();
        JFr_Consumo.cliente=tablalistado.getValueAt(fila, 4).toString();
        
        
        JFr_Consumo form = new JFr_Consumo();
        MDI_Inicio.escritorio.add(form);
        form.toFront();
        form.setVisible(true);
    ...
    private void btnrealizarpagosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnrealizarpagosActionPerformed
        ...
        JFr_Pago.idreserva = tablalistado.getValueAt(fila, 0).toString();
        JFr_Pago.cliente = tablalistado.getValueAt(fila, 4).toString();
        JFr_Pago.totalreserva =Double.parseDouble( tablalistado.getValueAt(fila, 11).toString());
        
        JFr_Pago.idhabitacion = tablalistado.getValueAt(fila, 1).toString();
        JFr_Pago.habitacion = tablalistado.getValueAt(fila, 2).toString();
        
        JFr_Pago form = new JFr_Pago();
        MDI_Inicio.escritorio.add(form);
        form.toFront();
        form.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFr_Reserva.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFr_Reserva().setVisible(true);
            }
        });
    }
